...
--------------------------------------------------------------------------------
  ...
  eqding.ogg   DING     level up  (from Titanium EQ levelup.wav)
  bag.ogg      BAG      B key / open-close bags / bank  (itemclth.wav)
  loot.ogg     LOOT     loot window open / take item  (buyitem.wav)
  equip.ogg    EQUIP    equip or unequip gear  (wearclth.wav)

  Autoloot: loot sound plays only once per corpse/chest.
  Multi-bag open (B): bag sound is throttled to a single play.
  Merchant sound disabled due to WoW sound overriding (File in \Sounds\merchant.wav)
